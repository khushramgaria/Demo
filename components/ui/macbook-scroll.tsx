...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[165vh] flex flex-col items-center py-0 md:py-16 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50"
    >
      <motion.h2
        style={{
  ...
  return (
    <div className="relative [perspective:800px]">
      ...
      <motion.div
        ...
        className="h-full w-[32rem] absolute inset-0 bg-black rounded-2xl"
      >
        <div className="absolute inset-0 bg-[#272729] rounded-lg" />
        <div className="w-[calc(100%)] mx-auto rounded-md overflow-hidden">
          <Vortex
            backgroundColor="black"
            className="flex flex-col px-6 py-10 w-full h-full"
          >
            <h1 className="text-4xl text-white">
            How We Dive <br /> Your Brand To New{" "}
            <span className="font-light text-3xl text-gray-400">Height</span>
          </h1>
            <p className="text-sm pt-4 pb-16 font-light text-white">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Ut eos
            doloremque recusandae vel, atque dignissimos. Ex dicta laborum
            soluta maiores! Rem sed minima iste repellendus placeat aliquam,
            voluptas dolor commodi ab dolores reprehenderit laborum harum est,
            laboriosam officia autem magnam, suscipit ullam. Eaque commodi
            repellat maxime non temporibus nam veritatis?
          </p>
