          ...
          <CardContainer className="inter-var" key={idx}>
            <CardBody
              className={`bg-gray-50 relative group/card ${
                idx === 1 && "mt-40"
              }  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[30rem] h-auto rounded-xl p-6 border  `}
            >
              <CardItem
                translateZ={50}
